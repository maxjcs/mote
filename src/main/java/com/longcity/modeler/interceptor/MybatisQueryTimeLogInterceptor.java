package com.longcity.modeler.interceptor;
...
@Intercepts({
		...
		@Signature(type = Executor.class, method = "query", args = {
				...
				ResultHandler.class }) })
public class MybatisQueryTimeLogInterceptor implements Interceptor {

	private Properties properties;

	private static Logger logger = LoggerFactory
			.getLogger(MybatisQueryTimeLogInterceptor.class);
