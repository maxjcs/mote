                    ...
                    <div class="panel-body">
                              ...
                              <form method="post" role="form" id="searchForm"
                               ...
                               <div class="col-md-5">  
                                ...
                                <div class="form-group">
                                    ...
                                    <span class="control-label">${mote.alipayId?default('')}kg</span>
                                </div>
                                <div class="form-group">
                                    <label class="control-label">支付宝名：</label>
                                    <span class="control-label">${mote.alipayName?default('')}kg</span>
                                </div>
                                <div class="form-group">
                        ...
                        <div class="table-responsive">
                            <table cellspacing="0"
                                ...
                                <tr>
                                    <td><a class="text-blue" href="#">${detailVO.title?default('')}</a></td>
